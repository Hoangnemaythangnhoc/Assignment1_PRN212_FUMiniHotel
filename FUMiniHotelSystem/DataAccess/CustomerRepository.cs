    ...
    public class CustomerRepository : ICustomerRepository
    {
        ...
        private void InitializeData()
        {
            try
            {
                _customers = new List<Customer>
                {
                    ...
                    {
                        CustomerID = 1,
                        CustomerFullName = "Hai Quan",
                        Telephone = "0348888702",
                        EmailAddress = "hhqan61@gmail.com",
                        CustomerBirthday = new DateTime(2004, 6, 1),
                        CustomerStatus = 1,
                        Password = "123"
                    },
                    new Customer
                    {
                        CustomerID = 2,
                        CustomerFullName = "Quan",
                        Telephone = "0987654321",
                        EmailAddress = "quan@email.com",
                        CustomerBirthday = new DateTime(2005, 5, 5),
                        CustomerStatus = 1,
                        Password = "456"
                    }
                };
        ...
        public Customer GetCustomerByEmail(string email)
        {
            try
            {
                ...
                return _customers.FirstOrDefault(c => c != null &&
